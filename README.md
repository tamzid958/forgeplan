...
--- Git Hosting (for automatic PR creation) ---
...
The `.env` file stores your credentials and settings. It is **never committed to git**.

| Variable | Required | Description |
|----------|----------|-------------|
| `OP_BASE_URL` | Yes | Your OpenProject URL (e.g., `https://op.example.com`) |
| `OP_API_KEY` | Yes | OpenProject API token |
| `OP_PROJECT_ID` | Yes | Project slug from OpenProject URL |
| `REPO_ROOT` | Yes | Absolute path to your repository root |
| `GIT_HOST_TYPE` | No | `github`, `gitlab`, or `bitbucket` (for PR creation) |
| `GIT_HOST_TOKEN` | If PR | Personal access token for your git hosting platform |
| `GIT_HOST_REPO` | If PR | Repository slug (e.g., `org/repo-name`) |
| `REVIEWERS` | No | Comma-separated usernames for PR reviewers |
...
| `GIT_BASE_BRANCH` | No | Base branch for new branches (default: `develop`) |
...
|----------|----------|---------|-------------|
| `OP_BASE_URL` | Yes | — | OpenProject instance URL |
| `OP_API_KEY` | Yes | — | OpenProject API token |
| `OP_PROJECT_ID` | Yes | — | OpenProject project slug |
| `REPO_ROOT` | Yes | — | Absolute path to repo root |
| `GIT_REMOTE` | No | `origin` | Git remote name |
| `GIT_BASE_BRANCH` | No | `develop` | Base branch for new branches |
| `GIT_HOST_TYPE` | No | — | `github`, `gitlab`, or `bitbucket` |
| `GIT_HOST_TOKEN` | If PR | — | Git hosting platform token |
| `GIT_HOST_REPO` | If PR | — | Repository slug (e.g., `org/repo`) |
| `REVIEWERS` | No | — | Comma-separated PR reviewer usernames |
